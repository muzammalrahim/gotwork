    ...
    <div class="grid grid-cols-5 gap-3 mx-auto sm:px-6 lg:px-16 mb-3 lg:mt-8 mt-8">
        ...
        <div class="lg:col-span-4 md:col-span-5 sm:col-span-5 col-span-5 overflow-hidden shadow-sm sm:rounded-lg lg:h-screen bg-white p-2">
            ...
            <div class="grid grid-cols-4 gap-3 searchProjectBox border-b border-gray-400 lg:text-base md:text-base text-xs">
                <form action="{{ route('dashboard') }}" method="get" class="bg-white p-4 flex h-16 lg:col-span-2 md:col-span-4 sm:col-span-4 col-span-4">
                    ...
                    <button href="{{ route('dashboard') }}" class="ml-4 bg-red-400 hover:bg-red-300 rounded text-white p-2 pl-4 pr-4">
                ...
                <form action="{{ route('dashboard') }}" method="get" class="flex lg:col-span-1 md:col-span-2 sm:col-span-2 col-span-2 md:w-60">  
