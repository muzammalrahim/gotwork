...
<label for="title" class="block text-black font-semibold">What skills required for the project?</label>
<small class="lg:text-sm md:text-sm sm:text-sm text-xs">Enter up to 5 skills that best describe your project. These skills are used to find the projects by the <strong>freelancers</strong> they are most interested and experienced in.</small>
...
<div x-data="dropdown()" x-init="loadOptions()" class="w-full flex flex-col mx-auto">
	...
	<input name="skill" type="hidden" x-bind:value="selectedValues()">
	            ...
	            <div class="my-2 p-1 flex border border-blue-500 bg-white rounded svelte-1l8159u">
	                <div class="flex flex-auto flex-wrap">
	                    ...
	                    <div x-show="selected.length    == 0" class="flex-1">
	                        <input placeholder="Select skills from here..."
