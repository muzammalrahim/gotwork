<div class="lg:px-16 md:px-8 sm:px-4 px-4 border-b border-gray-300 text-base">
    	@foreach ($user->qualifications as $qualif)
			...
			<div class="grid grid-cols-12 gap-4">
				...
				<!-- Delete Button -->
				<a href="{{ route('personal-qualification.remove', ['id' => $qualif->id]) }}" class="mt-2 pt-3 cursor-pointer text-red-600 bg-red-100" onclick="return confirm('Are you sure you want to delete this item?');"> <span class="text-red-600 text-lg m-9 md:m-4">X</span> </a>
			</div>
